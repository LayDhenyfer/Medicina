...
?>
    <main class="single">
        <section class="banner">
            <div class="wrapper">
                <div class="banner__video">
                    ...
                    <?php
                    if (get_field('link_do_video', $post->id)) :
                        echo '<img src="'. get_field('thumbail') .'" alt="">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/'. get_field('link_do_video', $post->id) .'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                    else :
                        echo '<img src="' . get_field('thumbail') . '" alt="YouTube video player">';
                        endif;
                    ?>
                </div>
            </div>
        ...
        <section class="readmore">
            <div class="wrapper">
                <h2 class="readmore__heading">Alguns dos nossos vídeos</h2>
                <div class="readmore__cards">
                    <?php
                    $args = array(
                        'post_type'      => 'videos',
                        'orderby' => 'date',
                    ...
                    if ($wp_query->have_posts()) :
                        while ($wp_query->have_posts()) :
                            $wp_query->the_post();
                    ?>
                            <div class="readmore__cards--items">
                                <figure>
                ...
                <a href="/videos" class="btn btn-white">
                    Saiba mais
                    <svg width="18" height="11" viewBox="0 0 18 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.9357 0L12.0845 0.851176L15.6957 4.46236H0V5.66617H15.6956L12.0845 9.27724L12.9357 10.1284L18 5.06421L12.9357 0Z" fill="#4a72b0"></path>
                    </svg>
                </a>
            </div>
        </section>
